...
if (workbox) {
    console.log("Timer (final countdown) workbox is loaded!");
...
/* Install a new service worker and have it update and control a web page as soon as possible */
workbox.core.skipWaiting();
    workbox.core.clientsClaim();
} else {
    console.log("Timer (final countdown) Workbox is not loaded!");
}